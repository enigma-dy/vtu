...
exports.setDataPrices = exports.getVtuDataPrices = exports.fetchVtuDataPricing = void 0;
const axios_1 = __importDefault(require("axios"));
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const fetchVtuDataPricing = async (req, res) => {
    try {
        const response = await axios_1.default.get(`${process.env.VTU_PROVIDER}`);
        const rawPlans = response.data?.data;
        if (!Array.isArray(rawPlans)) {
            throw new Error('Unexpected response format: expected an array');
        }
        const servicesToInsert = rawPlans.map((plan) => ({
            name: plan.data_plan,
...
exports.fetchVtuDataPricing = fetchVtuDataPricing;
const getVtuDataPrices = async (req, res) => {
    try {
...
exports.getVtuDataPrices = getVtuDataPrices;
const setDataPrices = async (req, res) => {
...
exports.setDataPrices = setDataPrices;
